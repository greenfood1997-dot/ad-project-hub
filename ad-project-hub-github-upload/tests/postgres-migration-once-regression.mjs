...
assert(source.includes("extracted_fields->>'costAggregationMode' = 'snapshot'"), "cost repair must only use a parser-confirmed multi-period snapshot");
...
assert(source.includes('2026-07-24-v3'), "the corrected repair must rerun for projects missed by earlier versions");
