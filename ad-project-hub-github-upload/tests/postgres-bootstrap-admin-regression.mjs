...
assert(bootstrap.includes('dbMode() !== "postgres"'), "bootstrap PIN must only apply to PostgreSQL");
assert(bootstrap.includes("if (admin.pinHash || admin.pin)"), "bootstrap must never overwrite existing credentials");
