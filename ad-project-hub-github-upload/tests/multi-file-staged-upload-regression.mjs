...
assert(dialog.includes("stageFilesForPreview") && dialog.includes("uploadFileBinary(file"), "files should be staged independently as binary before batch preview");
...
assert(main.includes("stageFilesForPreview") && main.includes("uploadFileBinary(file"), "production entry should use staged binary multi-file uploads");
